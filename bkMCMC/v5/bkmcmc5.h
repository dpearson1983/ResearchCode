 ...
 * May 17, 2017
 * 
 * This header is going to replace bkmcmc2.h and hopefully actually FUCKING WORK!
 * 
...
__constant__ float d_p[5];     //    160 bytes
       // total constant memory:   34976 bytes out of 65536 bytes
