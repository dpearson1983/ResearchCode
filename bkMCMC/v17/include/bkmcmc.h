...
__device__ double bispec_model(int x, float &phi, float3 k) {
    ...
    float b1 = (1.0 + 0.2*d_af[2]*(n1 + 3.0)*powf(q1*d_af[6], n1 + 3.0 + d_af[7]))/(1.0 + 
                powf(q1*d_af[6], n1 + 3.5 + d_af[7]));
    float b2 = (1.0 + 0.2*d_af[2]*(n2 + 3.0)*powf(q2*d_af[6], n2 + 3.0 + d_af[7]))/(1.0 + 
                powf(q2*d_af[6], n2 + 3.5 + d_af[7]));
    ...
    b1 = (1.0 + 0.2*d_ag[2]*(n1 + 3.0)*powf(q1*d_ag[6], n1 + 3.0 + d_ag[7]))/(1.0 + 
                powf(q1*d_ag[6], n1 + 3.5 + d_ag[7]));
    b2 = (1.0 + 0.2*d_ag[2]*(n2 + 3.0)*powf(q2*d_ag[6], n2 + 3.0 + d_ag[7]))/(1.0 + 
                powf(q2*d_ag[6], n2 + 3.5 + d_ag[7]));
