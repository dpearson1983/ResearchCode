...
//
// Compile with:
// g++ -lfftw -lrfftw -lfftw_threads -lrfftw_threads -lm -fopenmp -march=native -mtune=native -O2 NewSimPKCodeLRG.cpp -o NewSimPKCodeLRG
...
const unsigned int N_x = 512; // Size of the FFT in x
const unsigned int N_y = 512; // Size of the FFT in y
const unsigned int N_z = 512; // Size of the FFT in z
const unsigned int N_tot = N_x*N_y*N_z; // Size of FFT arrays

const double L_x = 1024.0;
const double L_y = 1024.0;
const double L_z = 1024.0;
...
const string galbase = "LRG";
const string ranbase = "randoms";
const string galinfobase = "LRGNum";
const string pkbase = "Power_SpectrumLRG";
