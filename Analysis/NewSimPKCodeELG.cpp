...
//
// Compile with:
// g++ -lfftw -lrfftw -lfftw_threads -lrfftw_threads -lm -fopenmp -march=native -mtune=native -O2 NewSimPKCodeELG.cpp -o NewSimPKCodeELG
...
const string galbase = "ELG";
const string ranbase = "randoms";
const string galinfobase = "ELGNum";
const string pkbase = "Power_SpectrumELG";
